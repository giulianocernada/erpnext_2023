...
// PASO 8: REMUEVO LAS FILAS DE LA TABLA SECUNDARIA DE RASGOS DIRECTOS EN EVALUACIONES
async function paso8a() {
    await new Promise(resolve => {
        if(paso_6comprobacionRealizada === true){
            while (paso_6i--){   
                resolve(
                    paso_6listaFiltrada.forEach(function(element){
                        element.forEach(function(element2){
                            if(paso_6tabla[paso_6i].nombre.includes(element2["nombre"])){
