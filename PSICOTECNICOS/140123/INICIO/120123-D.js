...
async function correrFunciones(){
	...
	await paso_6b(1000)
    await paso_6b(1000)
	await paso_6superyo(5000)
    await guardar(1000)
    await paso_6ello(5000)
    await guardar(1000)
    await paso_6simismo(5000)
    await guardar(1000)
    await paso_7(1000)
	await paso_7b(5000)
...
async function paso_6superyo(tiempo) {
    await new Promise(resolve => {
		resolve(
            frappe.msgprint({
                title: __('Notificacion'),
                indicator: 'green',
                message: __('PASO SUPERYO INICIADO')
            }),
            frappe.call({ 
                method:"frappe.client.get_list", 
                args: { 
...
async function paso_6ello(tiempo) {
    await new Promise(resolve => {
		resolve(
            frappe.msgprint({
                title: __('Notificacion'),
                indicator: 'green',
                message: __('PASO ELLO INICIADO')
            }),
            frappe.call({ 
                method:"frappe.client.get_list", 
                args: { 
...
async function paso_6simismo(tiempo) {
    await new Promise(resolve => {
		resolve(
            frappe.msgprint({
                title: __('Notificacion'),
                indicator: 'green',
                message: __('PASO SI MISMO INICIADO')
            }),
            frappe.call({ 
                method:"frappe.client.get_list", 
                args: { 
