...
async function correrFunciones(){
    ...
    await paso_12b(5000,4)
    await paso_12b(5000,5)
    await paso_12b(5000,6)
    await paso_12b(5000,7)
    await paso_12b(5000,8)
    await paso_12b(5000,9)
    await paso_12b(5000,10)
    await paso_13(1000);
    await paso_14a(1000);
    await paso_14b(1000);
    await paso_15a(1000);
...
async function comprobarTabla4() {
	if(cur_frm.doc.protocolo_de_psicotecnico === "PRO.PSI.DVI-I"){
		if(cur_frm.doc.table_166.length != 11) {
            await paso_17b(2000)
            if(cur_frm.doc.table_166.length != 11) {
                await paso_17b(3000)
                if(cur_frm.doc.table_166.length != 11) {
