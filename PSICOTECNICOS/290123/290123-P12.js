...
let paso_12indirectoPsicotecnicob
...
async function paso_12c(){
    await new Promise(resolve => {
        frappe.call({ 
            ...
            callback: function(r) {
                resolve(
                    paso_12indirectoPsicotecnicob = r.message,
                    console.log(paso_12indirectoPsicotecnicob)
                )
            }
        })
    })
            ...
            frappe.call({ 
                ...
                callback: function(t) {
                        ...
                        if(total_superyo != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_ desajuste_si_su"] != 1) frappe.call({ 
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_superyo - paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) > paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_su"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_su"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_superyo - paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_su"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_superyo - paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_superyo != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] == 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] != 1){
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] == 1 && (((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion) > paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_su"]) && paso_12indirectoPsicotecnico[i]["limitante_maximo_ desajuste_si_su"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion) < paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_su"]) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_su"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion)  > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_superyo != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] == 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] != 1 &&  paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_su"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_su"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"])/cur_frm.doc.duracion  - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_su"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"])/cur_frm.doc.duracion  - (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_su"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] == 1 && (total_si_mismo +  paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_ello - paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_el"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_ello - paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] == 1 && (total_si_mismo +  paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"] - total_ello - paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] == 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] != 1){
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] == 1 && ((total_si_mismo +  paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  > paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_el"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] == 1 && ((total_si_mismo +  paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  < paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_el"]) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_el"]) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] == 1){
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] == 1 && ((total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] == 1 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] == 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_si_el"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_ desajuste_si_el"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_si_el"] == 1 && ((total_si_mismo +  paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_si_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"] - total_ello - paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"] - total_ello - paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"] - total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] == 1 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] != 1){
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && ((total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion) > paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && ((total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  < paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] == 1 && ((total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion)  > paso_12indirectoPsicotecnico[i]["maximo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] != 1 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] == 1){
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && ((total_superyo +  paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] == 1 && ((total_superyo +  paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] == 1 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] == 1){
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_desajuste_su_el"] == 1 && ((total_superyo +  paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion) < paso_12indirectoPsicotecnico[i]["minimo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_desajuste_su_el"] == 1 && ((total_superyo +  paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"])/cur_frm.doc.duracion  - (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"])/cur_frm.doc.duracion) > paso_12indirectoPsicotecnico[i]["maximo_desajuste_su_el"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) < paso_12indirectoPsicotecnico[i]["maximo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) >= paso_12indirectoPsicotecnico[i]["minimo_superyo"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) < paso_12indirectoPsicotecnico[i]["minimo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) > paso_12indirectoPsicotecnico[i]["maximo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_superyo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_superyo_c"] == 1){
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) /cur_frm.doc.duracion < paso_12indirectoPsicotecnico[i]["maximo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["minimo_superyo"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) /cur_frm.doc.duracion  < paso_12indirectoPsicotecnico[i]["minimo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_superyo"] == 1 && (total_superyo + paso_12indirectoPsicotecnico[i]["constante_del_superyo_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["maximo_superyo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) < paso_12indirectoPsicotecnico[i]["maximo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["minimo_ello"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) < paso_12indirectoPsicotecnico[i]["minimo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) > paso_12indirectoPsicotecnico[i]["maximo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_ello != 0 && paso_12indirectoPsicotecnico[i]["tiempo_ello_c"] == 1){
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) /cur_frm.doc.duracion < paso_12indirectoPsicotecnico[i]["maximo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["minimo_ello"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) /cur_frm.doc.duracion  < paso_12indirectoPsicotecnico[i]["minimo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_ello"] == 1 && (total_ello + paso_12indirectoPsicotecnico[i]["constante_del_ello_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["maximo_ello"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] != 1){
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] != 1)frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) < paso_12indirectoPsicotecnico[i]["maximo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) > paso_12indirectoPsicotecnico[i]["minimo_si_mismo"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) < paso_12indirectoPsicotecnico[i]["minimo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) > paso_12indirectoPsicotecnico[i]["maximo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                        ...
                        if(total_si_mismo != 0 && paso_12indirectoPsicotecnico[i]["tiempo_si_mismo_c"] == 1){
                            ...
                            if(paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] != 1 && paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) /cur_frm.doc.duracion < paso_12indirectoPsicotecnico[i]["maximo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["minimo_si_mismo"] && paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] != 1) frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_minimo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) /cur_frm.doc.duracion  < paso_12indirectoPsicotecnico[i]["minimo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
                            ...
                            if (paso_12indirectoPsicotecnico[i]["limitante_maximo_si_mismo"] == 1 && (total_si_mismo + paso_12indirectoPsicotecnico[i]["constante_del_si_mismo_c"]) /cur_frm.doc.duracion  > paso_12indirectoPsicotecnico[i]["maximo_si_mismo"])frappe.call({ 
                                method:"frappe.client.set_value", 
                                args: { 
                                    "doctype": "Rasgos de Personas", 
                                    "name": paso_12indirectoPsicotecnico[i]["name"],
